...
console.log(find2020(numbers));

//Part 2
const find2020With3Numbers = (arrayOfNumbers) => {
  for (let i = 0; i < arrayOfNumbers.length; i++) {
    for (let j = i + 1; j < arrayOfNumbers.length; j++) {
...
console.log(find2020With3Numbers(numbers));
